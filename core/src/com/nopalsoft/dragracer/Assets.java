...
public class Assets {
	...
	// coches
	public static AtlasRegion cocheDiablo;
	public static AtlasRegion cocheBanshee;
	public static AtlasRegion cocheTurismo;
	public static AtlasRegion cocheBullet;
	public static AtlasRegion cocheTornado;
	...
	public static void load() {
		...
		cocheDiablo = atlas.findRegion("Carros/diablo");
		cocheBanshee = atlas.findRegion("Carros/banshee");
		cocheTurismo = atlas.findRegion("Carros/turismo");
		cocheBullet = atlas.findRegion("Carros/bullet");
		cocheTornado = atlas.findRegion("Carros/tornado");
