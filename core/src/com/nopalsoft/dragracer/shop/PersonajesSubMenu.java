...
public class PersonajesSubMenu {
	...
	public static final int SKIN_COCHE_DIABLO = 0;
	public static final int SKIN_COCHE_BANSHEE = 1;
	public static final int SKIN_COCHE_TURISMO = 3;
	public static final int SKIN_COCHE_BULLET = 6;
	public static final int SKIN_COCHE_TORNADO = 2;

	public static final int SKIN_COCHE_AUDI_S5 = 4;
	public static final int SKIN_COCHE_BMW_X6 = 5;
	public static final int SKIN_COCHE_CHEVRLOTE_CROSSFIRE = 7;
	public static final int SKIN_COCHE_CITROEN_C4 = 8;
	public static final int SKIN_COCHE_DODGE_CHARGER = 9;
	public static final int SKIN_COCHE_FIAT_500_LOUNGE = 10;
	public static final int SKIN_COCHE_HONDA_CRV = 11;
	public static final int SKIN_COCHE_MAZDA_6 = 12;
	public static final int SKIN_COCHE_MAZDA_RX8 = 13;
	public static final int SKIN_COCHE_SEAT_IBIZA = 14;
	public static final int SKIN_COCHE_VOLKSWAGEN_SCIROCCO = 15;
	...
	final int PRECIO_COCHE_AUDI_S5 = 125;
	final int PRECIO_COCHE_BMW_X6 = 150;
	final int PRECIO_COCHE_CHEVRLOTE_CROSSFIRE = 200;
	final int PRECIO_COCHE_CITROEN_C4 = 225;
	final int PRECIO_COCHE_DODGE_CHARGER = 250;
	final int PRECIO_COCHE_FIAT_500_LOUNGE = 275;
	final int PRECIO_COCHE_HONDA_CRV = 300;
	final int PRECIO_COCHE_MAZDA_6 = 325;
	final int PRECIO_COCHE_MAZDA_RX8 = 350;
	final int PRECIO_COCHE_SEAT_IBIZA = 375;
	final int PRECIO_COCHE_VOLKSWAGEN_SCIROCCO = 400;
	...
	public PersonajesSubMenu(MainStreet game, Table contenedor) {
		...
		if (!didBuyAudiS5)
			lblPrecioAudiS5 = new Label(PRECIO_COCHE_AUDI_S5 + "",
					Assets.labelStyleChico);

		if (!didBuyBmwX6)
			lblPrecioBmwX6 = new Label(PRECIO_COCHE_BMW_X6 + "",
					Assets.labelStyleChico);
		...
		if (!didBuyCrossfire)
			lblPrecioCrossfire = new Label(PRECIO_COCHE_CHEVRLOTE_CROSSFIRE
					+ "", Assets.labelStyleChico);

		if (!didBuyCitroenC4)
			lblPrecioCitroenC4 = new Label(PRECIO_COCHE_CITROEN_C4 + "",
					Assets.labelStyleChico);

		if (!didBuyDodgeCharger)
			lblPrecioDodgeCharger = new Label(PRECIO_COCHE_DODGE_CHARGER + "",
					Assets.labelStyleChico);

		if (!didBuyFiat500)
			lblPrecioFiat500Lounge = new Label(PRECIO_COCHE_FIAT_500_LOUNGE
					+ "", Assets.labelStyleChico);

		if (!didBuyHondaCRV)
			lblPrecioHondeCRV = new Label(PRECIO_COCHE_HONDA_CRV + "",
					Assets.labelStyleChico);

		if (!didBuyMazda6)
			lblPrecioMazda6 = new Label(PRECIO_COCHE_MAZDA_6 + "",
					Assets.labelStyleChico);

		if (!didBuyMazdaRX8)
			lblPrecioMazdaRX8 = new Label(PRECIO_COCHE_MAZDA_RX8 + "",
					Assets.labelStyleChico);

		if (!didBuySeatIbiza)
			lblPrecioSeatIbiza = new Label(PRECIO_COCHE_SEAT_IBIZA + "",
					Assets.labelStyleChico);

		if (!didBuyVolkswagenScirocco)
			lblPrecioVOlkswagenScirocco = new Label(
					PRECIO_COCHE_VOLKSWAGEN_SCIROCCO + "",
					Assets.labelStyleChico);
		...
		contenedor
				.add(agregarPersonajeTabla(
						...
						lblPrecioTornado,
						Assets.cocheTornado,
						"Si puedes adelantar es porque te dejo.",
		...
		contenedor
				.add(agregarPersonajeTabla(
						...
						lblPrecioTurismo,
						Assets.cocheTurismo,
						"La Gasolina para la competición, el gasoil para la calefacción.",
		...
		contenedor
				.add(agregarPersonajeTabla("Ventura", lblPrecioAudiS5,
						Assets.audiS5, "Dale duro, que paga el seguro.", btBuyAudiS5))
				.expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla("XMW", lblPrecioBmwX6, Assets.bmwX6,
						"La carretera no es un circuito… pero nos apañamos.", btBuyBmwX6)).expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla(
						...
						lblPrecioCamaro,
						Assets.cocheBullet,
						"Muchas ráfagas, pero voy delante.",
		...
		contenedor
				.add(agregarPersonajeTabla("Crosstown", lblPrecioCrossfire,
						Assets.chevroletCrossfire, "Rotonda sin fuente, de frente.",
		...
		contenedor
				.add(agregarPersonajeTabla("Omega X", lblPrecioCitroenC4,
						Assets.citroenC4, "Yo también fui último modelo.", btBuyCitroenC4))
				.expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla("Vulcano", lblPrecioDodgeCharger,
						Assets.dodgeCharger, "La gente fina usa gasolina, diésel para las calderas.",
		...
		contenedor
				.add(agregarPersonajeTabla("Fiesta", lblPrecioFiat500Lounge,
						Assets.fiat500Lounge, "Tiene menos detalles que el interior de un FIAT Panda.",
		...
		contenedor
				.add(agregarPersonajeTabla("Comander", lblPrecioHondeCRV,
						Assets.hondaCRV, "Sin en inglés \"Car\" es coche, y \"Men\" es hombre... ¿Mi abuela Carmen es un transformer?", btBuyHondaCRV))
				.expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla("Orion", lblPrecioMazda6,
						Assets.mazda6, "La herida que más duele es el primer roce que le ves a tu coche nuevo.", btBuyMazda6))
				.expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla("Colorado", lblPrecioMazdaRX8,
						Assets.mazdaRX8, "¡Espabila, que vas pisando huevos!", btBuyMazdaRX8))
				.expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla("Formosa", lblPrecioSeatIbiza,
						Assets.seatIbiza, "Correr es una ciencia, pero correr con pasión es un arte.", btBuySeatIbiza))
				.expandX().fill();
		contenedor.row();
		...
		contenedor
				.add(agregarPersonajeTabla("SHU", lblPrecioVOlkswagenScirocco,
						Assets.volkswagenScirocco, "Diseño mis coches para correr, no para frenar.",
	...
	private void inicializarBotones() {
		...
		// DEFAULT
		btBuyDiablo = new TextButton("Escoger", Assets.styleTextButtonPurchased);
		if (Settings.skinSeleccionada == SKIN_COCHE_DIABLO)
		...
		btBuyDiablo.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				Settings.skinSeleccionada = SKIN_COCHE_DIABLO;
		...
		// SKIN_CARRO_BANSHEE
		if (didBuyBanshee)
			btBuyBanshee = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyBanshee = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_BANSHEE)
		...
		btBuyBanshee.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyBanshee) {
					Settings.skinSeleccionada = SKIN_COCHE_BANSHEE;
		...
		// SKIN_CARRO_TORNADO
		if (didBuyTornado)
			btBuyTornado = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyTornado = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_TORNADO)
		...
		btBuyTornado.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyTornado) {
					Settings.skinSeleccionada = SKIN_COCHE_TORNADO;
		...
		// SKIN_CARRO_TURISMO
		if (didBuyTurismo)
			btBuyTurismo = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyTurismo = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_TURISMO)
		...
		btBuyTurismo.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyTurismo) {
					Settings.skinSeleccionada = SKIN_COCHE_TURISMO;
		...
		// SKIN_CARRO_AUDI_S5
		if (didBuyAudiS5)
			btBuyAudiS5 = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyAudiS5 = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_AUDI_S5)
		...
		btBuyAudiS5.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyAudiS5) {
					Settings.skinSeleccionada = SKIN_COCHE_AUDI_S5;
					setSelected(btBuyAudiS5);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_AUDI_S5) {
					Settings.coinsTotal -= PRECIO_COCHE_AUDI_S5;
		...
		// SKIN_CARRO_BMW_X6
		if (didBuyBmwX6)
			btBuyBmwX6 = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyBmwX6 = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_BMW_X6)
		...
		btBuyBmwX6.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyBmwX6) {
					Settings.skinSeleccionada = SKIN_COCHE_BMW_X6;
					setSelected(btBuyBmwX6);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_BMW_X6) {
					Settings.coinsTotal -= PRECIO_COCHE_BMW_X6;
		...
		// SKIN_CARRO_BULLET
		if (didBuyBullet)
			btBuyBullet = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyBullet = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_BULLET)
		...
		btBuyBullet.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyBullet) {
					Settings.skinSeleccionada = SKIN_COCHE_BULLET;
		...
		// SKIN_CARRO_CHEVRLOTE_CROSSFIRE
		if (didBuyCrossfire)
			btBuyCrossfire = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyCrossfire = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_CHEVRLOTE_CROSSFIRE)
		...
		btBuyCrossfire.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyCrossfire) {
					Settings.skinSeleccionada = SKIN_COCHE_CHEVRLOTE_CROSSFIRE;
					setSelected(btBuyCrossfire);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_CHEVRLOTE_CROSSFIRE) {
					Settings.coinsTotal -= PRECIO_COCHE_CHEVRLOTE_CROSSFIRE;
		...
		// SKIN_CARRO_CITROEN_C4
		if (didBuyCitroenC4)
			btBuyCitroenC4 = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyCitroenC4 = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_CITROEN_C4)
		...
		btBuyCitroenC4.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyCitroenC4) {
					Settings.skinSeleccionada = SKIN_COCHE_CITROEN_C4;
					setSelected(btBuyCitroenC4);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_CITROEN_C4) {
					Settings.coinsTotal -= PRECIO_COCHE_CITROEN_C4;
		...
		// SKIN_CARRO_DODGE_CHARGER
		if (didBuyDodgeCharger)
			btBuyDodgeCharger = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyDodgeCharger = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_DODGE_CHARGER)
		...
		btBuyDodgeCharger.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyDodgeCharger) {
					Settings.skinSeleccionada = SKIN_COCHE_DODGE_CHARGER;
					setSelected(btBuyDodgeCharger);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_DODGE_CHARGER) {
					Settings.coinsTotal -= PRECIO_COCHE_DODGE_CHARGER;
		...
		// SKIN_CARRO_FIAT_500_LOUNGE
		if (didBuyFiat500)
			btBuyFiat500Lounge = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyFiat500Lounge = new TextButton("Comprar",
					Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_FIAT_500_LOUNGE)
		...
		btBuyFiat500Lounge.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyFiat500) {
					Settings.skinSeleccionada = SKIN_COCHE_FIAT_500_LOUNGE;
					setSelected(btBuyFiat500Lounge);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_FIAT_500_LOUNGE) {
					Settings.coinsTotal -= PRECIO_COCHE_FIAT_500_LOUNGE;
		...
		// SKIN_CARRO_HONDA_CRV
		if (didBuyHondaCRV)
			btBuyHondaCRV = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyHondaCRV = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_HONDA_CRV)
		...
		btBuyHondaCRV.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyHondaCRV) {
					Settings.skinSeleccionada = SKIN_COCHE_HONDA_CRV;
					setSelected(btBuyHondaCRV);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_HONDA_CRV) {
					Settings.coinsTotal -= PRECIO_COCHE_HONDA_CRV;
		...
		// SKIN_CARRO_MAZDA_6
		if (didBuyMazda6)
			btBuyMazda6 = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyMazda6 = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_MAZDA_6)
		...
		btBuyMazda6.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyMazda6) {
					Settings.skinSeleccionada = SKIN_COCHE_MAZDA_6;
					setSelected(btBuyMazda6);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_MAZDA_6) {
					Settings.coinsTotal -= PRECIO_COCHE_MAZDA_6;
		...
		// SKIN_CARRO_MAZDA_RX8
		if (didBuyMazdaRX8)
			btBuyMazdaRX8 = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyMazdaRX8 = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_MAZDA_RX8)
		...
		btBuyMazdaRX8.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyMazdaRX8) {
					Settings.skinSeleccionada = SKIN_COCHE_MAZDA_RX8;
					setSelected(btBuyMazdaRX8);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_MAZDA_RX8) {
					Settings.coinsTotal -= PRECIO_COCHE_MAZDA_RX8;
		...
		// SKIN_CARRO_SEAT_IBIZA
		if (didBuySeatIbiza)
			btBuySeatIbiza = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuySeatIbiza = new TextButton("Comprar", Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_SEAT_IBIZA)
		...
		btBuySeatIbiza.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuySeatIbiza) {
					Settings.skinSeleccionada = SKIN_COCHE_SEAT_IBIZA;
					setSelected(btBuySeatIbiza);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_SEAT_IBIZA) {
					Settings.coinsTotal -= PRECIO_COCHE_SEAT_IBIZA;
		...
		// SKIN_CARRO_VOLKSWAGEN_SCIROCCO
		if (didBuyVolkswagenScirocco)
			btBuyVolkswagenScirocco = new TextButton("Escoger",
					Assets.styleTextButtonPurchased);
		else
			btBuyVolkswagenScirocco = new TextButton("Comprar",
					Assets.styleTextButtonBuy);

		if (Settings.skinSeleccionada == SKIN_COCHE_VOLKSWAGEN_SCIROCCO)
		...
		btBuyVolkswagenScirocco.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				if (didBuyVolkswagenScirocco) {
					Settings.skinSeleccionada = SKIN_COCHE_VOLKSWAGEN_SCIROCCO;
					setSelected(btBuyVolkswagenScirocco);
				}
				else if (Settings.coinsTotal >= PRECIO_COCHE_VOLKSWAGEN_SCIROCCO) {
					Settings.coinsTotal -= PRECIO_COCHE_VOLKSWAGEN_SCIROCCO;
