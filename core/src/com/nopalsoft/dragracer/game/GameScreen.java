...
public class GameScreen extends Screens {
    ...
    private void initUI() {
        ...
        lbScore = new Label("Distancia 0m", Assets.labelStyleGrande);
        ...
        // Gameover
        lbTryAgain = new Label("Volver a Jugar", Assets.labelStyleGrande);
        ...
        lbShopScreen = new Label("Tienda", Assets.labelStyleGrande);
        ...
        lbLeaderboard = new Label("TOP 10", Assets.labelStyleGrande);
    ...
    private void updateRunning(float delta) {
        ...
        lbScore.setText("Distancia " + score + "m");
